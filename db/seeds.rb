...
Role.create(salary:456789997, character_name:"Loki", actor_id:ginger_spice.id, movie_id:mean_girls.id)
Role.create(salary:56557897, character_name:"Baba", actor_id:lindsay_lohan.id, movie_id:marvel.id)
